...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("ca.sheridancollege.ca.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("ca.sheridancollege.ca.security.DomainUserDetailsService", "createSpringSecurityUser");
